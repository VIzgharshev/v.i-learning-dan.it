...
import {IconsWrapper, Favorite, Cart} from "./Icons.styled.jsx";
import FavoriteWindow from "../FavoritesWindow/FavoriteWindow.jsx";
...
export default function Icons(props) {
    ...
    return (
        <IconsWrapper>
            ...
            {favoritesWindow && <FavoriteWindow favorites={props.favorites}
                                                onDeleteFavorites={props.onDeleteFavorites}/>}
            {cartWindow && <CartWindow cart={props.cart}
