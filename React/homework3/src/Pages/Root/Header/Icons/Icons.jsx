...
import FavoriteWindow from "../FavoritesWindow/FavoriteWindow.js";
import CartWindow from "../CartWindow/CartWindow.js";
export default function Icons(props) {

    const [favoritesWindow, setFavoritesWindow] = useState(false)
    const [cartWindow, setCartWindow] = useState(false)

        return (
            <IconsWrapper>
                <Favorite>
                    <svg onClick={() => setFavoritesWindow(!favoritesWindow)}
                         viewBox="0 0 30 30"
                         width="60"
                         height="60"
                         fill='none'
                ...
                <Cart>
                    <svg onClick={() => setCartWindow(!cartWindow)}
                ...
                {this.state.favoritesWindow && <FavoriteWindow favorites={props.favorites}
                                                               onDeleteFavorites={props.onDeleteFavorites}/>}
                {this.state.cartWindow && <CartWindow cart={props.cart}
